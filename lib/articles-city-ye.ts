...
export const cityAndYeArticles: Article[] = [
  {
    ...
    body: [
      ...
      "[PHOTOS:/articles/ye-alamodome-july-4-2026/ye-alamodome-inline.png|Ye's live production has always operated at arena scale — San Antonio gets the full version on the Fourth.]",
      "## Know before you go",
