...
export const shows: Show[] = [
  {
    ...
    date: '2026-07-04',
    doorsTime: 'Doors TBA',
    ticketUrl: 'https://www.ticketmaster.com/ye-tickets/artist/781032',
    ticketProvider: 'Ticketmaster',
    featured: true,
    note: 'Fourth of July — America\'s 250th. One of the largest concerts in Alamodome history.',
    source: 'manual',
  },
  {
  ...
  {
    id: 'acl-festival-weekend-one-2026-10-02',
    artist: 'ACL Festival — Weekend One',
    venue: 'Zilker Park',
    city: 'Austin',
    state: 'TX',
    date: '2026-10-02',
    ticketUrl: 'https://www.aclfestival.com',
    ticketProvider: 'Front Gate',
    source: 'manual',
  },
  {
    id: 'acl-festival-weekend-two-2026-10-09',
    artist: 'ACL Festival — Weekend Two',
    venue: 'Zilker Park',
    city: 'Austin',
    state: 'TX',
    date: '2026-10-09',
